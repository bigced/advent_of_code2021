...
def test_calculate_move_and_multiply_results(
    ...
    position = {"h": 0, "d": 0}
    mocked_execute_instructions_on_submarine.return_value = {"h": 15, "d": 10}
    ...
    mocked_print.assert_called_once_with("The multiplication of H and D = 150")
